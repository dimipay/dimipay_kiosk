      ...
      child: Row(
        ...
        children: [
              ...
              Obx(
                () => Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: FaceSignService.to.faceSignStatus ==
                            FaceSignStatus.success
                        ? null
                        : Border.all(
                            color: FaceSignService.to.faceSignStatus ==
                                    FaceSignStatus.loading
                                ? DPColors.grayscale300
                                : DPColors.primaryNegative,
                            width: 1,
                          ),
                    image: FaceSignService.to.faceSignStatus ==
                            FaceSignStatus.success
                        ? DecorationImage(
                            image: NetworkImage(
          ...
          GestureDetector(
            ...
            onTapDown: (_) => ProductPageController.to.pressedButton = "retry",
            onTapUp: (_) {
