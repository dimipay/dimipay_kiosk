...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new dev.ms.convert_native_img_stream.ConvertNativeImgStreamPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin convert_native_img_stream, dev.ms.convert_native_img_stream.ConvertNativeImgStreamPlugin", e);
    }
    try {
